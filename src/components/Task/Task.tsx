...
function Task({
  ...
  return (
    <article
      className={`${Styles.task} ${task.status === "awaiting" ? Styles.awaiting : task.status === "inProgress" ? Styles.inProgress : Styles.completed}`}
    >
      ...
      <p className={Styles.status}>
        sub task id's: {task.subTaskIds.join(", ")}
      </p>
